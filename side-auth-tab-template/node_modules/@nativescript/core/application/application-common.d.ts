...
export declare const on: typeof IApplication.on;
export declare const off: typeof IApplication.off;
export declare const notify: typeof IApplication.notify;
export declare const hasListeners: typeof IApplication.hasListeners;
...
export declare let inBackground: boolean;
export declare let suspended: boolean;
export declare function setInBackground(value: boolean): void;
export declare function setSuspended(value: boolean): void;
