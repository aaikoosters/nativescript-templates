...
NsHttpBackEnd.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.2", ngImport: i0, type: NsHttpBackEnd, deps: [{ token: i1.XhrFactory }, { token: i2.NSFileSystem }], target: i0.ɵɵFactoryTarget.Injectable });
