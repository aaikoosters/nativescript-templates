...
export declare class ListViewComponent<T = any> implements DoCheck, OnDestroy, AfterContentInit, TemplatedItemsHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListViewComponent<any>, "ListView", never, { "items": "items"; }, { "setupItemView": "setupItemView"; }, ["itemTemplateQuery"], never, false, never>;
}
...
export declare class TemplateKeyDirective<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TemplateKeyDirective<any>, "[nsTemplateKey],[nsTemplateKeys]", never, { "nsTemplateKey": "nsTemplateKey"; "nsTemplateKeys": "nsTemplateKeys"; }, {}, never, never, false, never>;
}
